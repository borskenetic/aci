...
<div class="container mt-4">
    ...
    <p class="text-muted small mb-4">
        Summaries are built from <strong>library gate IN scans</strong>. If someone forgets to scan OUT, the system automatically closes their visit at the end of the day.
    </p>
