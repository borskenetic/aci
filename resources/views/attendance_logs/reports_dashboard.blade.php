...
<div class="container py-4">
    ...
    <p class="text-muted small mb-3">
        Based on <strong>library gate IN scans</strong>. “Distinct days with IN” counts at most <strong>one calendar day per patron</strong> per distinct date, even with multiple INs that day.
    </p>
