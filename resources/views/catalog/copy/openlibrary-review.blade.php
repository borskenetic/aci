...
<div class="openlibrary-review">
    ...
    @if(!empty($record['cover_image']))
        <div class="mb-4">
            <div class="fw-semibold small text-muted mb-2">Cover (Open Library)</div>
    ...
    <form id="addBookForm" method="POST" action="{{ route('book.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="catalog_source" value="openlibrary">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted small mb-1">Leave empty to use the Open Library cover above.</p>
