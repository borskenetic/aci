                    ...
                    <div class="col-md-6">
                        ...
                        <select name="year" class="form-select">
                            ...
                            <option value="1st Year"
                                {{ old('year', $student->year) == '1st Year' ? 'selected' : '' }}>
                                1st Year
                            </option>

                            <option value="2nd Year"
                                {{ old('year', $student->year) == '2nd Year' ? 'selected' : '' }}>
                                2nd Year
                            </option>

                            <option value="3rd Year"
                                {{ old('year', $student->year) == '3rd Year' ? 'selected' : '' }}>
                                3rd Year
                            </option>

                            <option value="4th Year"
                                {{ old('year', $student->year) == '4th Year' ? 'selected' : '' }}>
                                4th Year
                            </option>

                            <option value="5th Year"
                                {{ old('year', $student->year) == '5th Year' ? 'selected' : '' }}>
                                5th Year
                            </option>

                            <option value="6th Year"
                                {{ old('year', $student->year) == '6th Year' ? 'selected' : '' }}>
                                6th Year
                            </option>
                        </select>
                    </div>
