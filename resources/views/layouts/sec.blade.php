    ...
    <div class="d-flex align-items-center px-4 py-2 flex-wrap staff-top-bar" style="background-color: white; position: relative;">
        ...
        <div id="routeWrapper" class="d-flex gap-2 flex-wrap ms-lg-auto responsive-nav">
            ...
            <div class="attendance_dropdown">
                <button id="ad" class="attendance_dropdown-button">Attendance</button>
            ...
            <a href="{{ route('landing') }}" id="home" class="btn2 btn-sm {{ request()->routeIs('books.landing') ? 'active-btn' : '' }}">OPAC</a>

            <div class="logs_dropdown">
                <button id="ad" class="logs_dropdown-button">Create Account</button>
            ...
            <div class="logs_dropdown">
                <button id="ad" class="logs_dropdown-button">Circulation</button>
                <div class="logs_dropdown-content">
            ...
            <div class="logs_dropdown">
                <button id="ad" class="logs_dropdown-button">Admin</button>
                <div class="logs_dropdown-content">
            ...
            <div class="logs_dropdown">
                <button id="ad" class="logs_dropdown-button">Room Reservations</button>
                <div class="logs_dropdown-content">
                    ...
                    <a href="{{ route('admin.attendance.feedbacks') }}" class="feedback-link">Attendance Feedback</a>
                    @can('isAdmin')
