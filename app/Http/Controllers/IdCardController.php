...
class IdCardController extends Controller
{
    ...
    public function front($id)
    {
        ...
        if ($student->course) {
            ...
            $img->text($course, 280, 705, function ($font) use ($courseFontSize) {
                $font->file(public_path('fonts/arial.ttf'));
        ...
        if ($student->id_number) {
            ...
            $idLength = strlen($id_number);
        
            // Base size for id_number text
            $idFontSize = 35;
        
   
            $img->text($id_number, 135, 345, function ($font) use ($idFontSize) {
                $font->file(public_path('fonts/arial.ttf'));
